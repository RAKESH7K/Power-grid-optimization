...
<body style="background-image:url(assetsc/images/breadcrumbs/1.gif); background-size:cover;">
<br><br>
                    ...
                    <form action="login_log.php" method="post" autocomplete="off">
                        ...
                        <div class="row">                                                          
                            <div class="col-xs-4 pull-left">
                                <br>
                                <a href="sign_up.php" class="btn btn-success btn-block btn-flat">Sign Up</a>
                            </div>    
                             <div class="col-xs-4 pull-right">
                                <br>
                                <a href="forgot.php" class="btn btn-info btn-block btn-flat">Forgot</a>
                            </div> 
                             <div class="col-xs-4 pull-right">
                                <br>
