...
function barChart() {
  am5.ready(function () {
    ...
    var data = [
      ...
      {
        country: "THRISSUR",
        value: Math.random(1600),
      },
      {
        country: "ERNAKULAM",
        value: Math.random(2660),
      },
      {
        country: "KOTTAYAM",
        value: Math.random(1430),
      },
      {
        country: "ALAPUZHA",
        value: Math.random(1330),
      },
      {
        country: "KOLLAM",
        value: Math.random(1575),
      },
      {
        country: "IDUKKI",
        value: Math.random(1155),
      },
      {
        country: "THIRUVANATHAPURAM",
        value: Math.random(2625),
      },
    ];
